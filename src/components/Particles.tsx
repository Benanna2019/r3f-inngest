...
export function Particles({ speed, fov, aperture, focus, curl, size = 512, ...props }: { speed: number, fov: number, aperture: number, focus: number, curl: number, size: number, [key: string]: unknown }) {
